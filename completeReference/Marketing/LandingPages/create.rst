...
#. Fill in the landing page title (**Titles**) and translate it into the languages supported in your OroCommerce configuration. 
   ...
   To manage title translations, click |IcTranslate| next to the **Titles** box and follow the guidance `here <../../commonActions/manage-translation.html>`_).
...
#. Click on the Slug Prototypes box. The default slug prototype will be autogenerated. Edit the value to customize the default.
   ...
   To ensure that slug prototype trnaslation is localization-friendly, manage slug prototype translations: click |IcTranslate| next to the **Slug Prototypes** box and follow the guidance `here <../../commonActions/manage-translation.html>`_).
