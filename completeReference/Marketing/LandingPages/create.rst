...
#. Click **Create Landing Page**. The following page opens:
   ...
   .. image:: /completeReference/img/Marketing/LandingPages/LandingPagesCreate2.png
       :class: with-border

#. Fill in the landing page title (**Titles**) and translate it into the languages supported in your OroCommerce configuration. 

   To manage title translations, click |IcTranslate| next to the **Titles** box and follow the guidance `here <../../commonActions/manage-translations.html>`_).
...
#. Click on the Slug Prototypes box. The default slug prototype will be autogenerated. Edit the value to customize the default.
   ...
   To ensure that slug prototype trnaslation is localization-friendly, manage slug prototype translations: click |IcTranslate| next to the **Slug Prototypes** box and follow the guidance `here <../../commonActions/manage-translations.html>`_).

#. Enter the landing page content in the `WYSIWYG text editor <../../commonActions/using-WYSIWYG-text-editor.html>`_ or use the source code mode (**<>**) to enter the html code.
...
#. In the SEO section, manage the meta description and meta keywords that will be incapsulated in the landing page.
   ...
   Meta description would summarise the page contents in one or several sentences (~160 characters).

   Meta keywords are comma separated words and phrases that describes the content in the most presised and relevant way that help find the page via the search engines (e.g. Google, Yahoo, Bing, etc). 
