...
.. image:: /completeReference/img/Dashboards/Dashboard/dashboards/header.png
...
.. image:: /completeReference/img/Dashboards/Dashboard/dashboards/dashboard_tools.png

| 

- Get to the `Edit form <../../../completeReference/Advanced/dataManagement/form.html>`_ of the dashboard: |IcEdit| 
...
.. |Bplus| image:: /completeReference/img/common/buttons/Bplus.png
   :align: middle
   
.. |IcBulk| image:: /completeReference/img/common/buttons/IcBulk.png
   :align: middle
   
.. |IcDashboard| image:: /completeReference/img/common/buttons/IcDashboard.png
   :align: middle   

.. |SectionDropD| image:: /completeReference/img/Dashboards/Dashboard/dashboards/section_dd.png
   :align: middle   
   
.. |HeaderDropD| image:: /completeReference/img/Dashboards/Dashboard/dashboards/header_dd.png
   :align: middle   
   
.. |WidgetList| image:: /completeReference/img/Dashboards/Dashboard/dashboards/widget_list.png
   :align: middle      

.. |ManageWidget| image:: /completeReference/img/Dashboards/Dashboard/dashboards/manage_widget.png
   :align: middle 
   
.. |DActionIcons| image:: /completeReference/img/Dashboards/Dashboard/dashboards/dashboard_action_icons.png
   :align: middle 
