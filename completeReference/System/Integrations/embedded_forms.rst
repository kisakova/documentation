...
You can preview the form on its `View page <../../../completeReference/Advanced/data_management/view.html>`_ page:
...
- From the gird, you can manage the Contact Request using the action icons:
  ...
  - Get to the `Edit from <../../../completeReference/Advanced/dataManagement/form.html>`_ of the form: |IcEdit|

  - Get to the `View page <../../../completeReference/Advanced/data_management/view.html>`_ of the form:  |IcView|
