...
By default, OroCommerce calculates tax using a rate defined in the built-in tax rule (`Managing tax rules </user-guide/taxes/index.html#managing-tax-rules>`_) for the default shipping origin address.
