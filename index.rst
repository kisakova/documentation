...
.. raw:: HTML
    ...
    <table class="no-border" border="0" style="width:100%;align:center;">
        <colgroup>
            <col width="33%"/>
            <col width="34%"/>
            <col width="33%"/>
    ...
    <table class="no-border" border="0" style="width:100%;align:center;">
        ...
        <tbody valign="top">
            ...
            <tr haligh="center" class="row-even">
                ...
                <td style='text-align:left;vertical-align:top' >
                    <ul>
                       <li><a href="./community/contribute.html">Source Code</a></li>
                       <li><a href="./community/translations.html">Translation</a></li>
                       <li><a href="./community/write.html">Documentation</a></li>
                       <li>Quality Assurance:
                           <ul>
                             <li><a href="./community/issues/issue.html">Report an Issue</b></a></li>
                             <li><a href="./community/issues/security.html">Report Security Issue</b></a></li>
                             <li><a href="./community/issues/translation.html">Report Translation Issue</a></li>
                             <li><a href="./community/issues/documentation.html">Report Documentation Issue</a></li>
                           </ul>
                       </li>
                    </ul>
                </td>
